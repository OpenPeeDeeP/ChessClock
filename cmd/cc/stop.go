...
var reasons = make(map[string]chessclock.StopRequest_Reason)
...
func init() {
	reasons["eod"] = chessclock.StopRequest_EndOfDay
	reasons["break"] = chessclock.StopRequest_Break
	reasons["lunch"] = chessclock.StopRequest_Lunch
}
